...
def parse_args():
    ...
    parser.add_argument('--cfg', dest='cfg_file',
                        ...
                        default='cfg/eval/eval_zikai_poem.yml', type=str)
...
if __name__ == "__main__":
    ...
    ###############Add for batch evaluation + calculate RP
    col_RP_names = ["epoch", "R_mean", "R_std"]
    df_RP = pd.DataFrame(columns = col_RP_names)
    start_t = time.time()
    for epoch_num in np.linspace(100,1500,15):
        model_dir = '../output/mirror_train/lambda50/poem_image/poem_image_cycle_2021_07_06_09_50_22/Model/netG_epoch_' + str(int(epoch_num)) + '.pth'
        ...
        if cfg.TRAIN.FLAG:
            ...
            if cfg.B_VALIDATION:
                ...
                df_RP.to_csv ('Mirror_result/RP_lambda_50.csv', index = False, header=True)
            else:
